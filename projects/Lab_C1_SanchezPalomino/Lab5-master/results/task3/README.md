...
## Muestra el resultado de salida
    * Una vez modificado el código lo compilamos mediante el comando 'icpx -fsycl mult_complex.cpp -o mult_complex' dando lugra a un ejecutable que al ejecutarlo nos da el resultado: 

Target Device: Intel(R) Core(TM) i5-10300H CPU @ 2.50GHz
